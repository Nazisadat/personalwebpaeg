      ...
      <div className={classes.centerDrawer}>
        <List style={{ width: "100%" }}>
          <ListItem
            ...
            style={{
              backgroundColor: chekActiveRoute("/") ? "#037fff" : "transparent",
              paddingLeft: 0,
              paddingRight: 0,
            }}
            onClick={() => {
          ...
          <ListItem
            ...
            style={{
              backgroundColor: chekActiveRoute("/about")
                ? "#037fff"
                : "transparent",
              paddingLeft: 0,
              paddingRight: 0,
            ...
            <ListItemText
              ...
              children={
                <Typography
                  className="listItemText"
                  style={{
                    color: chekActiveRoute("/about") ? "#fff" : "#a4acc4",
                  }}
                  variant="body2"
                >
                  {translate.about}
          ...
          <ListItem
            ...
            style={{
              backgroundColor: chekActiveRoute("/resume")
                ? "#037fff"
                : "transparent",
              paddingLeft: 0,
              paddingRight: 0,
            ...
            <ListItemText
              ...
              children={
                <Typography
                  className="listItemText"
                  style={{
                    color: chekActiveRoute("/resume") ? "#fff" : "#a4acc4",
                  }}
                  variant="body2"
                >
                  {translate.resume}
          ...
          <ListItem
            ...
            style={{
              backgroundColor: chekActiveRoute("/contact")
                ? "#037fff"
                : "transparent",
              paddingLeft: 0,
              paddingRight: 0,
            ...
            <ListItemText
              ...
              children={
                <Typography
                  className="listItemText"
                  style={{
                    color: chekActiveRoute("/contact") ? "#fff" : "#a4acc4",
                  }}
                  variant="body2"
                >
                  {translate.contact}
